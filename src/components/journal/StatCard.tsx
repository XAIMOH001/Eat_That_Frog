...
export function StatCard({ icon: Icon, label, value, hint, tone = "default" }: Props) {
  return (
    <div className="rounded-3xl bg-[#e0e5ec] p-5 shadow-[9px_9px_16px_#a3b1c6,-9px_-9px_16px_#ffffff]">
      <div className="flex items-start justify-between gap-3">
        <p className="text-xs font-semibold tracking-[0.14em] text-muted-foreground uppercase">
          {label}
        </p>
        <span className="grid size-9 shrink-0 place-items-center rounded-full bg-[#e0e5ec] shadow-[inset_3px_3px_6px_#a3b1c6,inset_-3px_-3px_6px_#ffffff]">
